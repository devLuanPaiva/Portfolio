...
export default function AboutMe() {
    return (
        <section className="mt-6 max-w-[60%]">
            <h2 className="text-1xl sm:text-2xl md:text-3xl lg:text-4xl tracking-wider font-bold bg-gradient-to-b from-white to-gray-400 bg-clip-text text-transparent">Sobre</h2>
            <TextGenerateEffect
